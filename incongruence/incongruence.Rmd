...
`r colorize("Are shallow or deep branches collapsed? Why are is your answer more likely to be collapsed?", "blue")`
...
Solution
```{bash, eval=F}
Often, deeper branches in a phylogeny will have lower support values because more ancient divergences are more difficult to
accurately infer. Thus, deeper, not shallower, branches are more likely to be collapsed.
```
